...
class OptimizedIndividualFormScreen extends StatefulWidget {
  const OptimizedIndividualFormScreen({super.key});

  @override
  State<OptimizedIndividualFormScreen> createState() =>
      _OptimizedIndividualFormScreenState();
}

class _OptimizedIndividualFormScreenState
    extends State<OptimizedIndividualFormScreen> {
  ...
  Widget build(BuildContext context) {
    if (firstTimeFlag == false) {
      ...
      final IndividualTableDetail = ModalRoute.of(context)!.settings.arguments;
      if (IndividualTableDetail == null) {
        print('------------>FAB: Insert/Save:');
      } else {
        print('----------->ListView: Received:Edit/Delete');
        IndividualTableDetail as IndividualTableModel;
        ...
        _natureOfBusinessController.text =
            IndividualTableDetail.natureOfBusiness;
